        ...
        <div style={{
            ...
            <div>
                <div class="container">
                    ...
                    <p>At Your Service is a platform which brings readers, writers and their stories together.<br></br> From the next door neighbour reading stories in the afternoon,<br></br> to the funny college kid downstairs, millions of people around you are using <br></br>this app to discover, express and share their stories in the language they love.</p>
                    <p>
                        <p>
                            <p></p>
                        </p>
                    ...
                    <div class="container">
                        <div class="stat">
                            ...
                            <div class="item"><h2>readers</h2></div>

                            <div class="number"><h1>27L+</h1></div>
                            <div class="item"><h2>stories</h2></div>

                            <div class="number"><h1>2.7L+</h1></div>
                            <div class="item"><h2>writers</h2></div>
                        </div>
                    </div>
                    <p>  <p>  <p>  <p>  <p> <p> </p></p></p></p></p></p>

                    <div class="about-item reverse">
                        <img src="https://www.pratilipi.com/images/about-1.webp" alt="flashback" />
                    </div>
