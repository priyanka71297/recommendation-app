...
// import Category from "../models/Category";
// import { fetchBookByName } from "../redux/BookSlice";
// import {getBookByIdService, getBookByNameService, getAllBooksService, addBookService } from "../services/BookService";
...
//                 console.log(response.data);
//                 setBook(response.data);
//                 dispatch(fetchBookByName(response.data)); 
//                 setName('');
//             })
//             .catch((error) => {
//                 alert(error);
...
//             .then((response) => {
//                 console.log(response.data);
//                 alert(`Book with bookName ${response.data.bookName} added successfully.`);
//             })
//             .catch(() => {
//                 setBookToBeAdded(new Book());
//                 bookTemp = '';
...
//             </div>
//             <div className="bg-white shadow shadow-regular mb-3 mt-3 px-3 py-3 pb-3 pt-3 col-4">
//                 <p className="lead">Find a Book By Name</p>
//                 <div>
//                     <form className="form form-group">
//                         <input
//                             type="text"
...
//                 <div> {(bookDataFromStore.bookName) &&
//                     <div>
//                         <p className="lead text-primary">book details</p>
//                         <p>Book Id: {bookDataFromStore.bookId} </p>
//                         <p> Book Name: {bookDataFromStore.bookName} </p>
//                         <p> Book Price: {bookDataFromStore.price} </p>
//                         <p> Book Rating: {bookDataFromStore.rating} </p>
...
//                                                 <td>{b.price}</td>
//                                                 <td>{b.rating}</td>
//                                                 <td>{(b.author && b.author.authorId)}</td>
//                                                 <td>{(b.author && b.author.authorName)}</td>
//                                                 <td>{(b.category && b.category.categoryId)}</td>
//                                                 <td>{(b.category && b.category.category)}</td>
//                                             </tr>
//                                         </tbody>
//                                     ))}
