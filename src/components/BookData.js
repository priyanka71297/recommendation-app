...
//                                 //     <div class="card-body">
//                                 //         <h5 class="card-title">Author Name: {(b.author && b.author.authorName)}</h5>
//                                 //         <p class="card-text">Category: {(b.category && b.category.category)}</p>
//                                 //         <p class="card-text">Rating : {b.rating} Price: {b.price}</p>
...
//                                 <div class="column">
//                                     <div class="card">
//                                         <p>Book Name: {b.bookName}</p>
//                                         <p>Author Name: {(b.author && b.author.authorName)}</p>
//                                         <p>Category: {(b.category && b.category.category)}</p>
//                                         <p>Rating : {b.rating} Price: {b.price}</p>
//                                     </div>
//                                 </div>
